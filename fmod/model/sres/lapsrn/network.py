...
from fmod.model.sres.common.unet import DoubleConv
...
class LapSRN(nn.Module):
    def __init__(self, n_channels: int, nfeatures: int, downscale_factors: List[int], ups_mode: str ):
...
def get_model( mconfig: Dict[str, Any] ) -> nn.Module:
    ...
    return LapSRN( nchannels, nfeatures, downscale_factors, ups_mode )
