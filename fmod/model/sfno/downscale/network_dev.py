...
from fmod.base.util.ops import pctnant
...
#			inverse_transform = self.itrans_up if last_layer else self.itrans
	...
	def norm_layer(self, shape):
		if self.normalization_layer == "layer_norm":
			norm_layer = partial( nn.LayerNorm, normalized_shape=shape, eps=1e-6 )
		elif self.normalization_layer == "instance_norm":
			norm_layer = partial(nn.InstanceNorm2d, num_features=self.embed_chans, eps=1e-6, affine=True, track_running_stats=False)
