...
class MERRA2InputIterator(object):
    ...
    def __next__(self):
        ...
        task_config = dict(cfg().task)
        (inputs, targets, forcings) = batch.extract_inputs_targets_forcings(train_data, target_lead_times=self.target_lead_times, **task_config )
